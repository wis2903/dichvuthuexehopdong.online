        ...
        <div className={styles.container} ref={containerRef}>
            <Wrapper className={styles.wrapper}>
                ...
                <div className={styles.block}>
                    ...
                    />
                    <div className={styles.label}>Tài xế Taxi Giá tốt tìm và trả lại khách hàng tài sản trên xe.</div>
                    <div className={styles.desc}>
                        ...
                        Hãng xe đã tuyên dương và tặng thưởng cho tài xế <span>Trương Quốc Tuấn</span>. Rất mong các tài xế của <span className={styles.name}>Taxi Giá tốt</span> sẽ có thêm nhiều hành động đẹp trên từng chuyến đi.
                    </div>
                </div>
                ...
                <div className={styles.block}>
                    ...
                    <div className={styles.desc}>
                        Không chỉ các mặt hàng tiêu dùng mới giảm giá <span>11/11</span>, <span className={styles.name}>Taxi Giá tốt</span> cũng giảm giá các chuyến đi từ <span>11/11</span> đến hết <span>31/11/2021</span>.
                    </div>
                </div>
                ...
                <div className={styles.block}>
                    ...
                    <div className={styles.desc}>
                        <span className={styles.name}>Taxi Giá tốt</span> giảm <span>20%</span> cho khách đặt xe đi đường dài, liên tỉnh đến hết <span>31/12/2021</span>.
                    </div>
                </div>
            </Wrapper>
        </div>
